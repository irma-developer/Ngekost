...
<div id="TopNav" class="relative flex items-center justify-between px-5 mt-[60px]">
            <a href="{{ route('home') }}"
                ...
                <img src="{{ asset('storage/assets/images/icons/arrow-left.svg') }}" class="w-[28px] h-[28px]" alt="icon">
            </a>
        ...
        <div id="Header" class="relative flex items-center justify-between gap-2 px-5 mt-[18px]">
            ...
            <button class="flex flex-col items-center text-center shrink-0 rounded-[22px] p-[10px_20px] gap-2 bg-white">
                <img src="{{ asset('storage/assets/images/icons/star.svg') }}" class="w-6 h-6" alt="icon">
                    ...
                    <div class="flex w-[120px] h-[183px] shrink-0 rounded-[30px] bg-[#D9D9D9] overflow-hidden">
                     ...
                     <div class="flex flex-col gap-3 w-full">
                            ...
                            <div class="flex items-center gap-[6px]">
                                <img src="{{ asset('storage/assets/images/icons/location.svg') }}" class="w-5 h-5 flex shrink-0" alt="icon">
                                <p class="text-sm text-ngekos-grey">{{ $boardingHouse->city->name }}</p>
                            </div>
                            <div class="flex items-center gap-[6px]">
                                <img src="{{ asset('storage/assets/images/icons/profile-2user.svg') }}" class="w-5 h-5 flex shrink-0"
                                    alt="icon">
